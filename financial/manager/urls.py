...
urlpatterns = [
    ...
    path('banco/<int:banco_id>/delete/', views.delete_banco, name='delete_banco'),
    ...
    path('parceiro/<int:parceiro_id>/delete/', views.delete_parceiro, name='delete_parceiro'),
    ...
    path('receber/<int:diario_id>/duplica/', views.duplica_receber, name='duplica_receber'),
    path('receber/<int:diario_id>/delete/', views.delete_receber, name='delette_receber'),
